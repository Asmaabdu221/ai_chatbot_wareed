...
const QUICK_ACTIONS = [
  ...
  { label: 'ابغى اعرف الفروع', text: 'ابغى اعرف الفروع' },
  { label: 'عندي نتيجه و ابغى تفسير', text: 'عندي نتيجه و ابغى تفسير' },
  { label: 'ابغى اتواصل مع خدمه العملاء', text: 'ابغى اتواصل مع خدمه العملاء' },
];
