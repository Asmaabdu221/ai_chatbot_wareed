...
_GENERIC_PHRASE_HINTS: dict[str, tuple[str, ...]] = {
    ...
    "ماهو سكر التراكمي": ("السكر التراكمي",),
    "ايش هو سكر التراكمي": ("السكر التراكمي",),
    "وش هو سكر التراكمي": ("السكر التراكمي",),
    "ماهو رمز سكر التراكمي": ("رمز", "السكر التراكمي"),
    "ماهو رمز السكر التراكمي": ("رمز", "السكر التراكمي"),
    "هل التحليل امن للاطفال": ("امنه", "الاطفال"),
    "هل التحاليل امن للاطفال": ("امنه", "الاطفال"),
    "هل التحاليل امنه للاطفال": ("امنه", "الاطفال"),
    "هل التحاليل امنه لكبار السن": ("امنه", "كبار السن"),
    "هل التحليل امن لكبار السن": ("امنه", "كبار السن"),
    "هل التحاليل امن لكبار السن": ("امنه", "كبار السن"),
    "هل الفحص امن للاطفال": ("امنه", "الاطفال"),
    "هل الفحص امن لكبار السن": ("امنه", "كبار السن"),
    "وين موجوده فروعكم": ("فروع",),
    "وين موجود الفروع": ("فروع",),
    "اين تتواجد فروكم": ("فروع",),
    "كيف اعرف اذا العرض القديم باقي": ("عرض", "قديم", "باقي"),
}
...
FAQ_CANONICAL_RULES: tuple[FAQCanonicalRule, ...] = (
    ...
    FAQCanonicalRule(
        ...
        trigger_phrases=(
            ...
            "هل التحليل امن للاطفال",
            "هل التحليل امن لكبار السن",
            "هل التحاليل امن للاطفال",
            "هل التحاليل امنه للاطفال",
            "هل التحاليل امن لكبار السن",
            "هل التحاليل امنه لكبار السن",
            "هل الفحص امن للاطفال",
            "هل الفحص امن لكبار السن",
        ),
        keyword_groups=(
            ("امنه", "الاطفال"),
            ("امن", "للاطفال"),
